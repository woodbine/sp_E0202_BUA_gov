...
# Set up variables
entity_id = "E0202_BUA_gov"
url = "http://www.bedford.gov.uk/council_and_democracy/council_budgets_and_spending/supplier_payments.aspx"
errors = 0
# Set up functions
    ...
    if 'Supplier Payments' in link.text:
        ...
        for link in links:
            if 'Excel' in link.text:
                url_csv = 'http://www.bedford.gov.uk/council_and_democracy/council_budgets_and_spending/' + link['href']
                csvfile = link.text
